    ...
    <div class="container">
      <div class="row vertical-offset-100">
        <div class="col-md-4 col-md-offset-4">
              ...
              <form class="form-signin" method="POST" action="<?php echo base_url();?>admin/license" role="form">
                <fieldset>
                  <div class="form-group">
                    <input class="form-control" placeholder="License Key" name="licensekey" type="text">
                  </div>
          ...
          <p class="text-center">   <a target="_blank" style="color: #1C1C1C" ><b></b></a> <?php echo PT_VERSION; ?></p>
        </div>
      </div>
    </div>
  </body>

...
class InvoiceController extends Controller
{
    ...
    public function invoice_download($id)
    {
        ...
        }elseif($currency_code == 'AED' || $currency_code == 'EGP' || $language_code == 'ar' || $currency_code == 'IQD' || $language_code == 'ir' || $language_code == 'om' || $currency_code == 'ROM' || $currency_code == 'SDG' || $currency_code == 'ILS'|| $language_code == 'jo'){

                ...
                <div class="home-slider">
                    @if (get_setting('home_slider_images') != null)
                        <div class="aiz-carousel dots-inside-bottom mobile-img-auto-height" data-autoplay="true">
                            @php
                                $lang = App::getLocale();
                                $slider_images = $lang == 'en' ? json_decode(get_setting('home_slider_images'), true) : json_decode(get_setting('home_slider_images_ar'), true);
                            @endphp
                            @if (!empty($slider_images))
                                @foreach ($slider_images as $key => $value)
                                    <div class="carousel-box" id="{{ App::getLocale() }}">
                    ...
                    <div class="row no-gutters border-top border-left">
                        @foreach ($featured_categories as $key => $category)
                            <div class="col-xl-4 col-md-6 border-right border-bottom">
                                <div class="bg-white pt-3 pl-3 pr-3 h-100 hov-scale-img"
                                    style="min-height: 240px !important;">
                                    <div class="row">
                                        <!-- Category Banner -->
                                        <div class="col-md-5 py-3 h-200px text-center h-md-100">
                                            <img src="{{ uploaded_asset($category->banner) }}"
                                                alt="{{ $category->getTranslation('name') }}"
                                                class="w-auto h-100 has-transition"
                                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                                        </div>
                                        <!-- Categories -->
                                        <div class="col py-3 text-center text-md-left">
                                            <!-- Category Name -->
                                            <h6 class="text-dark mb-3"><a class="text-reset fw-700 fs-14 hov-text-primary"

            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg">{{ translate('Ecommerce') }}</th>
                        <th data-breakpoints="lg">{{ translate('Commission') }}</th>
                        <th data-breakpoints="lg">{{ translate('Packages allowed') }}</th>
                ...
                <tbody>
                    @foreach ($categories as $key => $category)
                        <tr>
                            ...
                            <td>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" disabled ="" value="{{ $category->is_ecom_category }}"
                                        <?php if ($category->is_ecom_category == 1) {
                                            echo 'checked';
                                        } ?>>
                                    <span></span>
                                </label>
                            ...
                            <td>
                                ...
                                // foreach($all_packages[$category->id] as $key => $package){
                                //     echo "$package->label, ";
                                // }
                                ?>

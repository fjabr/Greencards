        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('customer_packages.update', $customer_package->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label">Number of members</label>
                        <div class="col-sm-9">
                            <input type="number" lang="en" min="0" step="1" placeholder="Number of members" value="{{ $customer_package->nb_members }}" id="nb_members" name="nb_members" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label">{{translate('Duration')}}</label>
                        <div class="col-sm-9">
                            <input type="number" lang="en" min="0" step="1" placeholder="{{translate('Duration')}}" value="{{ $customer_package->duration }}" id="duration" name="duration" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label">{{translate('Hidden')}}</label>
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <input value="1" name="hidden" type="checkbox" @if ($customer_package->hidden == 1)
                                checked
                            @endif>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label">{{translate('Hide in GreenCart')}}</label>
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <input value="1" name="hide_in_greencart" type="checkbox" @if ($customer_package->hide_in_greencart == 1)
                                checked
                            @endif>
                            <span class="slider round"></span>
                        </label>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label">{{translate('Hide in GreenCard')}}</label>
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <input value="1" name="hide_in_greencard" type="checkbox" @if ($customer_package->hide_in_greencard == 1)
                                checked
                            @endif>
                            <span class="slider round"></span>
                        </label>

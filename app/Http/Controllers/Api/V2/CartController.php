...
class CartController extends Controller
{
            ...
            foreach ($owner_ids as $owner_id) {
                ...
                if (!empty($shop_items_raw_data)) {
                    foreach ($shop_items_raw_data as $shop_items_raw_data_item) {
                        ...
                        $shop_items_data_item["product_name_ar"] = $product->getTranslation('name','ar');
                        $shop_items_data_item["est_shipping_days"] = $product->est_shipping_days;
                        ...
                        $shop_items_data_item["green_price"] = intval($product->green_price) ;
    ...
    public function add(Request $request)
    {
        ...
        if ($variant == '')
            ...
            if(isSubscribedUser(auth()->user()) && !empty($product->green_price)){

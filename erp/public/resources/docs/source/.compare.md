...
[Get Postman Collection](https://30.burj-alsaha.com/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"esse","ip_address":"dolorem","latitude":"quae","longitude":"eaque"}'
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"asperiores","latitude":"distinctio","longitude":"perferendis"}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/holidays?location_id=consequatur&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=nisi&follow_up_type=distinctio&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"est","schedule_type":"maxime","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "https://30.burj-alsaha.com/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"nobis","schedule_type":"in","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=beatae&biz_name=quos&mobile_num=11&contact_id=numquam&order_by=qui&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"consequuntur","mobile_name":"aliquam","call_type":"call","start_time":"rerum","end_time":"aperiam","duration":"voluptatibus"}]}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=ut&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":4,"initial_amount":3,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":86.9983619,"total_card_slips":18,"total_cheques":6,"closing_note":"vel","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/contactapi?type=possimus&name=voluptatem&biz_name=adipisci&mobile_num=4&contact_id=ipsam&order_by=numquam&direction=eligendi&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"deserunt","prefix":"quia","first_name":"eaque","middle_name":"autem","last_name":"animi","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"et","address_line_2":"dicta","city":"accusamus","state":"quas","country":"sint","zip_code":"commodi","customer_group_id":"voluptas","contact_id":"in","dob":"2000-06-13","custom_field1":"deserunt","custom_field2":"est","custom_field3":"qui","custom_field4":"ex","email":"nemo","shipping_address":"placeat","position":"sit","opening_balance":0,"source_id":11,"life_stage_id":6,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "deserunt",
    "prefix": "quia",
    "first_name": "eaque",
    "middle_name": "autem",
    "last_name": "animi",
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"minima","prefix":"sed","first_name":"placeat","middle_name":"sit","last_name":"ut","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"exercitationem","address_line_2":"quia","city":"minus","state":"rerum","country":"vel","zip_code":"sit","customer_group_id":"facilis","contact_id":"illo","dob":"2000-06-13","custom_field1":"eos","custom_field2":"exercitationem","custom_field3":"corporis","custom_field4":"aut","email":"quas","shipping_address":"voluptas","position":"optio","opening_balance":10.3,"source_id":11,"life_stage_id":5,"assigned_to":[]}'
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":3,"card_number":"et","card_holder_name":"vitae","card_transaction_number":"dignissimos","card_type":"omnis","card_month":"optio","card_year":"et","card_security":"deserunt","transaction_no_1":"exercitationem","transaction_no_2":"quam","transaction_no_3":"rerum","cheque_number":"cum","bank_account_number":"velit","note":"maiores"}'
...
let body = {
    ...
    "card_transaction_number": "dignissimos",
    "card_type": "omnis",
    "card_month": "optio",
    "card_year": "et",
    "card_security": "deserunt",
    "transaction_no_1": "exercitationem",
    "transaction_no_2": "quam",
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/expense?location_id=consectetur&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=ad&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":6,"final_total":4552452.476445,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":4,"expense_for":17,"contact_id":3,"additional_notes":"culpa","is_refund":0,"is_recurring":0,"recur_interval":16,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"vitae","recur_repetitions":9,"payment":[{"amount":453.13,"method":"cash","account_id":15,"card_number":"voluptatem","card_holder_name":"dolorum","card_transaction_number":"corrupti","card_type":"temporibus","card_month":"quasi","card_year":"modi","card_security":"quia","transaction_no_1":"commodi","transaction_no_2":"culpa","transaction_no_3":"illum","note":"architecto","cheque_number":"id"}]}'
    ...
    "payment": [
        {
            ...
            "card_holder_name": "dolorum",
            "card_transaction_number": "corrupti",
            "card_type": "temporibus",
            "card_month": "quasi",
            "card_year": "modi",
            "card_security": "quia",
            "transaction_no_1": "commodi",
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://30.burj-alsaha.com/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":61,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":14,"expense_for":9,"contact_id":19,"additional_notes":"aut","is_recurring":0,"recur_interval":8,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"tenetur","recur_repetitions":12,"payment":[]}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/expense-refund?location_id=repudiandae&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=aut&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/expense-refund"
);

let params = {
    "location_id": "repudiandae",
    "payment_status": "paid",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "expense_for": "aut",
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/product?order_by=voluptatem&order_direction=corporis&brand_id=quam&category_id=eaque&sub_category_id=voluptatum&location_id=quo&selling_price_group=aut&name=eos&sku=eligendi&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/product"
);

let params = {
    "order_by": "voluptatem",
    "order_direction": "corporis",
    "brand_id": "quam",
    "category_id": "eaque",
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/product/1?selling_price_group=rerum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/variation/2?product_id=totam&location_id=voluptatem&brand_id=magnam&category_id=est&sub_category_id=dolorum&not_for_selling=enim&name=tempore&sku=quasi&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/sell?location_id=ipsum&contact_id=sapiente&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=est&service_staff_id=numquam&shipping_status=ordered&only_subscriptions=voluptatem&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":19,"contact_id":13,"transaction_date":"2020-07-22 15:48:29","invoice_no":"beatae","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":8,"discount_amount":10,"discount_type":"fixed","sale_note":"soluta","staff_note":"ducimus","commission_agent":14,"shipping_details":"Express Delivery","shipping_address":"id","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":4,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":6,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"est","recur_repetitions":16,"rp_redeemed":9,"rp_redeemed_amount":13.5,"types_of_service_id":6,"service_custom_field_1":"error","service_custom_field_2":"placeat","service_custom_field_3":"amet","service_custom_field_4":"odit","service_custom_field_5":"inventore","service_custom_field_6":"ut","round_off_amount":3495775,"table_id":2,"service_staff_id":20,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":7,"note":"est"}],"payments":[{"amount":453.13,"method":"cash","account_id":14,"card_number":"libero","card_holder_name":"tempora","card_transaction_number":"fugiat","card_type":"molestiae","card_month":"assumenda","card_year":"doloribus","card_security":"totam","transaction_no_1":"eveniet","transaction_no_2":"et","transaction_no_3":"consequatur","bank_account_number":"a","note":"temporibus","cheque_number":"ut"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "error",
            "service_custom_field_2": "placeat",
            "service_custom_field_3": "amet",
            "service_custom_field_4": "odit",
            "service_custom_field_5": "inventore",
            "service_custom_field_6": "ut",
            "round_off_amount": 3495775,
            "table_id": 2,
            "service_staff_id": 20,
            "change_return": 0,
            "products": [
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://30.burj-alsaha.com/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":19,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":13,"discount_amount":10,"discount_type":"fixed","sale_note":"quia","staff_note":"ut","sells":[{"is_suspend":false}],"commission_agent":1,"shipping_details":"Express Delivery","shipping_address":"atque","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":3,"pay_term_number":10,"pay_term_type":"months","is_recurring":0,"recur_interval":12,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"ut","recur_repetitions":1,"rp_redeemed":19,"rp_redeemed_amount":13.5,"types_of_service_id":2,"service_custom_field_1":"sunt","service_custom_field_2":"alias","service_custom_field_3":"eaque","service_custom_field_4":"quisquam","service_custom_field_5":"repudiandae","service_custom_field_6":"id","round_off_amount":831860.71019,"table_id":4,"service_staff_id":3,"change_return":0,"change_return_id":19,"products":[{"sell_line_id":3,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":19,"discount_amount":0,"discount_type":"percentage","sub_unit_id":16,"note":"consequatur"}],"payments":[{"payment_id":18,"amount":453.13,"method":"cash","account_id":19,"card_number":"vero","card_holder_name":"et","card_transaction_number":"ducimus","card_type":"cupiditate","card_month":"perferendis","card_year":"nulla","card_security":"voluptatibus","transaction_no_1":"et","transaction_no_2":"ullam","transaction_no_3":"officiis","note":"voluptatem","cheque_number":"debitis","bank_account_number":"sapiente"}]}'
...
let body = {
    ...
    "service_custom_field_1": "sunt",
    "service_custom_field_2": "alias",
    "service_custom_field_3": "eaque",
    "service_custom_field_4": "quisquam",
    "service_custom_field_5": "repudiandae",
    "service_custom_field_6": "id",
    "round_off_amount": 831860.71019,
    "table_id": 4,
    "service_staff_id": 3,
    "change_return": 0,
    "change_return_id": 19,
    ...
    "payments": [
        {
            ...
            "card_number": "vero",
            "card_holder_name": "et",
            "card_transaction_number": "ducimus",
            "card_type": "cupiditate",
            "card_month": "perferendis",
            "card_year": "nulla",
            "card_security": "voluptatibus",
            "transaction_no_1": "et",
            "transaction_no_2": "ullam",
            "transaction_no_3": "officiis",
            "note": "voluptatem",
            "cheque_number": "debitis",
            "bank_account_number": "sapiente"
        }
    ]
}
...
```bash
curl -X DELETE \
    "https://30.burj-alsaha.com/public/connector/api/sell/ullam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":17,"transaction_date":"2020-5-7 15:20:22","invoice_no":"suscipit","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":6,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":8,"shipping_status":"ordered","delivered_to":"vel"}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/table?location_id=magnam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/taxonomy?type=nulla" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"natus","first_name":"fugiat","last_name":"veritatis","email":"ut","is_active":"dolores","user_type":"voluptatem","crm_contact_id":9,"allow_login":false,"username":"provident","password":"ratione","role":7,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"consequatur","max_sales_discount_percent":"labore","selected_contacts":true,"selected_contact_ids":[],"dob":"neque","gender":"unde","marital_status":"quia","blood_group":"neque","contact_number":"deleniti","alt_number":"beatae","family_number":"ea","fb_link":"mollitia","twitter_link":"perspiciatis","social_media_1":"hic","social_media_2":"vel","custom_field_1":"sed","custom_field_2":"aspernatur","custom_field_3":"atque","custom_field_4":"officiis","guardian_name":"voluptatibus","id_proof_name":"est","id_proof_number":"assumenda","permanent_address":"dignissimos","current_address":"veritatis","bank_details":[{"account_holder_name":"ut","account_number":"eligendi","bank_name":"dolor","bank_code":"quis","branch":"modi","tax_payer_id":"omnis"}]}'
...
let body = {
    ...
    "marital_status": "quia",
    "blood_group": "neque",
    "contact_number": "deleniti",
    "alt_number": "beatae",
    "family_number": "ea",
    "fb_link": "mollitia",
    "twitter_link": "perspiciatis",
    "social_media_1": "hic",
    "social_media_2": "vel",
    "custom_field_1": "sed",
    "custom_field_2": "aspernatur",
    "custom_field_3": "atque",
    "custom_field_4": "officiis",
    "guardian_name": "voluptatibus",
    "id_proof_name": "est",
    "id_proof_number": "assumenda",
    "permanent_address": "dignissimos",
    "current_address": "veritatis",
    "bank_details": [
        {
            "account_holder_name": "ut",
            "account_number": "eligendi",
            "bank_name": "dolor",
            "bank_code": "quis",
            "branch": "modi",
            "tax_payer_id": "omnis"
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/user?service_staff=voluptatibus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/user"
);

let params = {
    "service_staff": "voluptatibus",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"velit","new_password":"fugiat"}'
...
```bash
curl -X POST \
    "https://30.burj-alsaha.com/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"voluptas"}'
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/profit-loss-report?location_id=necessitatibus&start_date=2018-06-25&end_date=2018-06-25&user_id=qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/profit-loss-report"
);

let params = {
    "location_id": "necessitatibus",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "user_id": "qui",
};
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://30.burj-alsaha.com/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://30.burj-alsaha.com/public/connector/api/notifications"
);

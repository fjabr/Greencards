        ...
        <div class="col-lg-3 col-md-4 col-sm-12">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="mb-3 h6 fw-600">
                        @if($customer_package->nb_members > 1)
                            {{ $customer_package->nb_members }} members
                        @else
                            {{ $customer_package->nb_members }} member
                        @endif
                    </p>
                    ...
                    <p class="fs-15">{{translate('Package Duration') }}:
                        <b class="text-bold">{{$customer_package->duration}} {{translate('days')}}</b>
                    </p>
                    <div class="mar-top">

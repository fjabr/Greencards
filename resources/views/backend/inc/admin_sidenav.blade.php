        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @can('live_chat')
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('live_chat', 1) }}" class="aiz-side-nav-link" target="_blanck">
                                    <span class="aiz-side-nav-text">{{ translate('SERVICE PROVIDER') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('live_chat', 2) }}" class="aiz-side-nav-link" target="_blanck">
                                    <span class="aiz-side-nav-text">{{ translate("DO NOt  GET YOUR DISCOUNT") }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('live_chat', 3) }}" class="aiz-side-nav-link" target="_blanck">
                                    <span class="aiz-side-nav-text">{{ translate('PAYMENTS') }}</span>
                                </a>
                            </li>
                            @if (get_setting('vendor_system_activation') == 1)
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('live_chat', '5') }}" class="aiz-side-nav-link" target="_blanck">
                                        <span class="aiz-side-nav-text">{{ translate('TRAVEL BOOKING') }}</span>
                                    </a>
                                </li>
                            @endif
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('live_chat', 5) }}" class="aiz-side-nav-link" target="_blanck">
                                    <span class="aiz-side-nav-text">{{ translate('YOUR ACCOUNT') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('live_chat', 6) }}" class="aiz-side-nav-link" target="_blanck">
                                    <span class="aiz-side-nav-text">{{ translate('OTHER') }}</span>
                                </a>
                            </li>
                ...
                @can('contracts')
                    @if (get_setting('vendor_system_activation') == 1)
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('contracts') }}" class="aiz-side-nav-link">
                                <i class="las la-qrcode aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate("Contracts") }}</span>
                            </a>
                 ...
                 ************  end  contrat  section add **************

                ------------------->

                @can('invitation_link')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('customers.links.index') }}" class="aiz-side-nav-link">
                            <i class="las la-qrcode aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate("Invitation link") }}</span>
                        </a>
                    </li>
                @endcan
                 ...
                 ************  Start invitaion section add **************

                ------------------->

                <!--------

                 ************  end  invitaion  section add **************
                ...
                @can('invoices_mobile')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('invoices_mobile') }}" class="aiz-side-nav-link">
                            <i class="las la-qrcode aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate("Invoices Mobile") }}</span>
                        </a>
                ...
                @can('offers_types')
                    @if (get_setting('vendor_system_activation') == 1)
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('offers_types') }}" class="aiz-side-nav-link">
                                <i class="las la-qrcode aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate("Types Offers") }}</span>
                            </a>
                ...
                @can('notifications_mobile')
                @if (get_setting('vendor_system_activation') == 1)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('notifications_mobile') }}" class="aiz-side-nav-link">
                            <i class="las la-bell aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Notifications Mobile') }}</span>
                        </a>
                ...
                @endcanany
                @canany(['send_free_subscription'])

                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-money-bill aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Invitation') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        @can('send_free_subscription')
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('customer_packages.customer_with_free_sub') }}"
                                        class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Create New Customer with free trail subscription') }}</span>
                                    </a>
                                </li>
                            </ul>
                        @endcan
                ...
                @endcanany
                @canany(['sale_subscription', 'view_all_saled_subscriptions'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-money-bill aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Sale Subscriptions') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        @can('sale_subscription')
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('sale_subscription.sale_subscription') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Add New Subscritpion') }}</span>
                                    </a>
                                </li>
                            </ul>
                        @endcan
                        @can('view_all_saled_subscriptions')
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('sale_subscription.subscription') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('All Subscritpions') }}</span>
                                    </a>
                                </li>
                            </ul>
                        @endcan
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('sales_reports')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('sales-reports.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Sales Reports') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('seller_qr_reports')

                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('seller-qr-sale-report.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Seller QR Sales Reports') }}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                @canany(['banner_app_setup'])
                <li class="aiz-side-nav-item">
                    <a href="#"
                        class="aiz-side-nav-link {{ areActiveRoutes(['mobileSetup.banner']) }}">
                        <i class="las la-desktop aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Mobile Setup ') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        @can('banner_app_setup')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('mobileSetup.banners') }}" class="aiz-side-nav-link">

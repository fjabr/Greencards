            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="MSEGAT_API_BASE_URL">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('MSEGAT_API_BASE_URL')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MSEGAT_API_BASE_URL" value="{{  env('MSEGAT_API_BASE_URL') }}" placeholder="MSEGAT_API_BASE_URL" required>
                            </div>
                        </div>
                        <div class="form-group row">

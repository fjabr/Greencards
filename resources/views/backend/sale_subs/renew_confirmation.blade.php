    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('sale_subscription.renew_subscription_post') }}" method="POST">
                        ...
                        <div style="display: none">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" placeholder="{{ translate('Name') }}" id="first_name"
                                        value="{{ $user->name }}" name="first_name" class="form-control"
                                        >
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="payment_method" class="form-control" id="package">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col col-6">{{ $user->name }}</div>
                            </div>
                            <div class="row">
                                <div class="col col-6">{{ translate('Email') }}</div>
                                <div class="col col-6">{{ $user->email }}</div>
                            </div>
                            <div class="row">
                                <div class="col col-6">{{ translate('mobile') }}</div>
                                <div class="col col-6">{{$user->phone}}</div>
                            </div>
                            <div class="row">

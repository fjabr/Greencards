    ...
    <div class="form-search-main-01">
        <form autocomplete="off" name="flightmanualSearch" action="<?= $search->route; ?>" method="GET" role="search">
            <div class="form-inner">
                <div class="row  mb-10 row-reverse align-items-start row-return">
                    <div class="col-xs-6 col-md-6" style="margin-top:-5px">
                        ...
                        <div class="custom-control custom-radio  custom-control-inline">
                            <input type="radio" id="flightSearchRadio-2" name="triptype" class="custom-control-input return "  value="oneway" <?php if($search->tripType == "oneway") { ?> checked <?php } ?>>
                        ...
                        <div class="custom-control custom-radio  custom-control-inline" style="margin-top:-10px">
                            <input type="radio" id="flightSearchRadio-1" name="triptype" class="custom-control-input oneway"  value="round" <?php if($search->tripType == "round") { ?> checked <?php } ?>>
                ...
                <div class="clear"></div>
                  <div class="row no-gutters mb-15 align-items-end row-reverse">

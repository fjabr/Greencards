    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.offers') }}" class="aiz-side-nav-link">
                        <i class="las la-home aiz-side-nav-icon"></i>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.shop.subscriptionSellerReport') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['seller.shop.subscriptionSellerReport']) }}">
                        <i class="las la-cog aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('QR-based sale subscription reports') }}</span>
                    </a>
                </li>

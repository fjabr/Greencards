...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('/export-offline-customer-package-payment-requests', [CustomerPackagePaymentController::class, 'export_offline_payment_request'])->name('offline_customer_package_payment_request.export_offline_payment_request');

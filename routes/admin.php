...
use App\Http\Controllers\CustomerInviteLinkController;
...
use App\Http\Controllers\SaleSubscriptionsController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
         ...
         * start route contrat
         * */
        Route::get('/contracts', [OffersController::class ,'contracts'])->name('contracts');
            Route::post('/refuse_contract', [OffersController::class ,'refuse_contract'])->name('refuse_contract');
                Route::get('/approv_contract/{id}',[OffersController::class ,'approve_contracts'])->name('approv_contract');
        ...
        * */
        ...
        Route::get('/notifications_mobile', [OffersController::class ,'NotificationsMobile'])->name('notifications_mobile');
        Route::get('/add_notifications_mobile', [OffersController::class ,'AddNotificationsMobile'])->name('add_notifications_mobile');
        Route::post('/save_notifications_mobile', [OffersController::class ,'SaveNotificationsMobile'])->name('save_notifications_mobile');
        Route::get('/offers_types', [OffersController::class ,'index'])->name('offers_types');
        Route::get('/live_chat/{id}', [OffersController::class ,'live_chat'])->name('live_chat');

        Route::get('/invoices_mobile', [OffersController::class ,'invoices_mobile'])->name('invoices_mobile');
        Route::post('/export_invoices_mobile', [OffersController::class ,'export_invoices_mobile'])->name('export_invoices_mobile');
        Route::get('/get_invoices/{customerPackagePayment}', [OffersController::class ,'downloadInvoice'])->name('get_invoices');
        Route::get('/offers_types/create', [OffersController::class ,'create'])->name('offers_types.create');
        Route::post('/offers_types/store', [OffersController::class ,'store'])->name('offers_types.store');
        Route::get('/offers_types/edit/{id}', [OffersController::class ,'edit'])->name('offers_types.edit');
        Route::post('/offers_types/update/{id}', [OffersController::class ,'update'])->name('offers_types.update');
        Route::get('/offers_types/destroy/{id}', [OffersController::class ,'destroy'])->name('offers_types.destroy');
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::post('/sellers/approved', 'updateApproved')->name('sellers.approved');
            Route::post('/sellers/uncategorie', 'uncategorie')->name('sellers.uncategorie');
    });
    ...
    // Customer
        Route::controller(CustomerInviteLinkController::class)->group(function () {
            Route::get('/customers/invite_links', 'index')->name('customers.links.index');
        });
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::get('/customers/login/{id}', 'login')->name('customers.login');
            Route::get('/customers/resend_invoice/{id}', 'resendInvoice')->name('customers.resend_invoice');
            Route::get('/customers/destroy/{user}', 'destroy')->name('customers.destroy');
        ...
        Route::post('/export-customers-request', 'export_customers_request')->name('customers.export_customers_request');
    });
    ...
    Route::group(['prefix' => 'website'], function() {
     ...
     // mobile setting
     Route::group(['prefix' => 'mobile-settings'], function() {
        Route::controller(MobileSettingsController::class)->group(function () {
            Route::get('/banner', 'banner')->name('mobileSetup.banners');
        });
    });
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::get('/sales-reports', 'sales_reports')->name('sales-reports.index');
        Route::get('/sales-reports-export', 'sales_reports')->name('sales-reports.export');
        ...
        Route::get('/commission-log', 'commission_history')->name('commission-log.index');
        Route::get('/seller-qr-sale-report', 'seller_subscription_report')->name('seller-qr-sale-report.index');
    });
    ...
    //Customer Package
        Route::controller(CustomerPackageController::class)->group(function () {
            Route::get('/customer_packages/add_customer_with_free_sub', 'customer_with_free_sub')->name('customer_packages.customer_with_free_sub');
            Route::post('/customer_packages/add_customer_with_free_sub', 'add_customer_with_free_sub')->name('customer_packages.add_customer_with_free_sub');
        });
    ...
    Route::controller(CustomerPackageController::class)->group(function () {
        ...
        Route::controller(SaleSubscriptionsController::class)->group(function () {
            Route::get('/sale_sub', 'sale_sub')->name('sale_subscription.sale_subscription');
            Route::post('/renew_sub/confirmation', 'renew_subscription_confirmation')->name('sale_subscription.renew_subscription_confirmation');
            Route::post('/renew_sub/post', 'renew_subscription_post')->name('sale_subscription.renew_subscription_post');
            Route::get('/renew_sub/{user}', 'renew_sub')->name('sale_subscription.renew_subscription');
            Route::get('/sale_sub/subscriptions/{packagePayment}', 'subscription_details')->name('sale_subscription.details');
            Route::post('/sale_sub', 'add_customer')->name('sale_subscription.add_customer');
            Route::post('/sale_sub_confimation', 'confirmation')->name('sale_subscription.sale_sub_confimation');
            Route::get('/subscription', 'all_customer')->name('sale_subscription.subscription');
            Route::post('/upload_receipt', 'upload_receipt')->name('sale_subscription.upload_receipt');
    ...
    Route::resource('states', StateController::class);
        Route::controller(StateController::class)->group(function () {
            ...
            Route::post('/states/status',  'updateStatus')->name('states.status');
        });
    ...
    // CustomerInviteLinkController
    Route::controller(CustomerInviteLinkController::class)->group(function () {
        Route::post('/customers/invite_links/update/{invitationLink}', 'update')->name('customers.links.update');
        Route::get('/customers/invite_links', 'index')->name('customers.links.index');
        Route::get('/customers/invite_links/create', 'create')->name('customers.links.create');
        Route::post('/customers/invite_links/store', 'store')->name('customers.links.store');
        Route::get('/customers/invite_links/edit/{invitationLink}', 'edit')->name('customers.links.edit');
        Route::post('/customers/invite_links/delete/{invitationLink}', 'delete')->name('customers.links.delete');
    });
});

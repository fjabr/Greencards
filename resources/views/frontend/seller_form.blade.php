                    ...
                    <div class="bg-white border mb-4">
                        ...
                        <div class="p-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0{{ $errors->has('shop_name') ? ' is-invalid' : '' }}" value="{{ old('shop_name') }}" placeholder="{{ translate('Shop Name')}}" name="shop_name" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-3 rounded-0{{ $errors->has('address') ? ' is-invalid' : '' }}" value="{{ old('address') }}" placeholder="{{ translate('Address')}}" name="address" >
                            ...
                            <div class="form-group">
                                <label>{{translate('Countries')}} <span class="text-primary">*</span></label>
                                <select class="select2 form-control aiz-selectpicker {{ $errors->has('countries') ? ' is-invalid' : '' }}" name="countries[]" data-toggle="select2" data-placeholder="Choose ..."data-live-search="true" multiple>

...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user'], 'as' => 'seller.'], function () {
    ...
    // offers
        ...
        Route::controller(OfferController::class)->group(function () {
            ...
            Route::post('/send_contract/', 'contract')->name('contract.send');
    ...
    Route::controller(ShopController::class)->group(function () {
        ...
        Route::get('/branches', 'branches')->name('shop.branches');
        ...
        Route::get('/subscription_sales_report', 'sellerQrReport')->name('shop.subscriptionSellerReport');
    });
    ...
    Route::controller(AddressController::class)->group(function () {
        ...
        Route::post( 'getCities', 'get-cities' )->name( 'get-city');
        Route::get( 'getCities/{country_id}', 'getCitiesList' )->name( 'get-city-list');

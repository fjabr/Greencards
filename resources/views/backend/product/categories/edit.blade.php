            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
    	            ...
    	            <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="banner" class="selected-files" value="{{ $category->getTranslation('banner', $lang) }}">
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="icon" class="selected-files" value="{{ $category->getTranslation('icon', $lang) }}">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="cover_image" class="selected-files" value="{{ $category->getTranslation("cover_image") }}">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Packages')}}</label>
                        <div class="col-md-9">
                            <?php
                                $packages = explode(",", $category->packages_allowed);
                                foreach ($packages_base as $key => $package){
                                    $input = " <input type='checkbox' name='package[]' ";
                                    if(in_array($package->id, $packages)){
                                        $input = $input."checked";
                                    }
                                    echo $input." value='$package->id'/> $package->label ";
                                }
                            ?>
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('E-commerce category')}}</label>
                        <div class="col-md-9">
                            <label class="aiz-switch mb-0">
                                <input type="checkbox" name='ecom_category' <?php if($category->is_ecom_category) echo "checked";?> >
                                <span></span>

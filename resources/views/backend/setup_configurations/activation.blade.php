            ...
            <div class="card-body text-center">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="HYPERPAY_ACTIVE">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('HYPERPAY ACTIVE')}}</label>
                            </div>
                            <div class="col-md-8 row">
                                <div class="col">

                                    <input type="radio" name="HYPERPAY_ACTIVE" value="on" @if (env('HYPERPAY_ACTIVE') == "on")
                                        checked
                                    @endif/>
                                    <label>On</label>
                                </div>
                                <div class="col">
                                    ...
                                    <input type="radio" name="HYPERPAY_ACTIVE"  value="off" @if (env('HYPERPAY_ACTIVE') == "off")
                                        checked
                                    @endif/>
                                    <label>Off</label>
                                </div>
...
<div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6 text-center">{{translate('Hyperpay Mada Payment Activation')}}</h3>
            </div>
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ URL::asset('assets/img/cards/MADA.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'Hyperpay_payment')" <?php if(get_setting('Hyperpay_payment') == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    {{ translate('You need to configure hyperpay correctly to enable this feature') }}. <a href="{{ route('payment_method.index') }}">{{ translate('Configure Now') }}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6 text-center">{{translate('Hyperpay VISA,MASTER,AMEX Payment Activation')}}</h3>
            </div>
            <div class="card-body text-center">
                <div class="clearfix">
                    <img class="float-left" src="{{ URL::asset('assets/img/cards/MASTER.png') }}" height="30">
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'Hyperpay_visapayment')" <?php if(get_setting('Hyperpay_visapayment') == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">

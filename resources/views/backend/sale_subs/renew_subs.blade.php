    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('sale_subscription.renew_subscription_confirmation') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                disabled name="first_name" class="form-control"  value="{{$user->name}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="tel" id="phone-code" lang="en" min="0" step="1"
                                    ...
                                    class="form-control" disabled value="{{$user->phone}}">
                            </div>
                        </div>
                        <div class="form-group row">

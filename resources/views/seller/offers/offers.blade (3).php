                                                ...
                                                <body>
                                                      ...
                                                      <div style="break-after:page"></div>
                                                        ...
                                                        <thead>
                                                          ...
                                                          <tbody>
                                                          <tr>
                                                            <td style="width:50%" class="container"><p>On: {{ $contract->create_date }} of each between made was contract this:</p></td>
                                                            <td style="width:50%" class="containerAr"><p>:إنه في تاریخ {{ $contract->create_date }} حرر ھذا العقد بین كل من</p></td>
                                                          </tr>
                                                          <tr>
                                                            <td class="container">
                                                              <p>

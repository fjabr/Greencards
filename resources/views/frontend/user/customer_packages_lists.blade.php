                    ...
                    <div class="card overflow-hidden rounded-0 shadow-none border">
                        <div class="card-body">
                            ...
                            <div class="mb-5 d-flex align-items-center justify-content-center">
                                ...
                                @else
                                    <span style="font-size: 2.5rem;" class="display-4 fw-600 lh-1 mb-4">{{ single_price($customer_package->amount) }}</span>
                                @endif
                ...
                <div class="modal-body gry-bg px-3 pt-3" style="overflow-y: inherit;">
                    <form class="" id="package_payment_form" action="{{ route('customer_packages.purchase') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control rounded-0"  placeholder = '{{translate("coupon")}}'  data-live-search="true" name="coupon"/>
                            </div>
                        </div>

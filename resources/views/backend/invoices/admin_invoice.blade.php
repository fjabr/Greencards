	...
	<style media="all">
		...
		@if($currency_code == 'BDT')
			@font-face {
	            ...
	            src: url("{{ URL::asset('assets/fonts/HindSiliguri-Regular.ttf') }}") format("truetype");
	            font-weight: normal;
	            font-style: normal;
	        }
	        *{
	    ...
	    @elseif($currency_code == 'ILS')
			@font-face {
	            font-family: 'Cairo';
	            src: url("{{ URL::asset('assets/fonts/Cairo-Regular.ttf') }}") format("truetype");
	            font-weight: normal;
	            font-style: normal;
	        }
	        *{
        ...
        @else
        	@font-face {
	            font-family: 'Roboto';
	            src: url("{{ URL::asset('assets/fonts/Roboto-Regular.ttf') }}") format("truetype");
	            font-weight: normal;
	            font-style: normal;
	        }
	        *{
			...
			<table>
				<tr>
					<td>
						...
						@else
							<img src="{{ URL::asset('assets/img/logo.png') }}" height="30" style="display:inline-block;">
						@endif
					</td>

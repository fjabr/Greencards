        ...
        <form action="{{ route('manual_payment_methods.update', $manual_payment_method->id) }}" method="POST">
          ...
          @csrf
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control aiz-selectpicker" name="type" id="type" required>
                            ...
                            <option value="mobile_app_offline_payment" @if($manual_payment_method->type == 'mobile_app_offline_payment') selected @endif>{{translate('Mobile App OffLine Payment')}}</option>
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label">{{translate('Arabic  Payment Instruction')}}</label>
                    <div class="col-sm-10">
                        <textarea class="aiz-text-editor" name="description_ar">@php echo $manual_payment_method->description_ar @endphp</textarea>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#type').on('change', function(){
                if($('#type').val() == 'bank_payment' || $('#type').val() == 'mobile_app_offline_payment'){

...
<div class="row">
	<div class="col-xl-10 mx-auto">
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Arabic Home Slider') }}</h6>
			</div>
			<div class="card-body">
				<div class="alert alert-info">
					{{ translate('We have limited banner height to maintain UI. We had to crop from both left & right side in view for different devices to make it responsive. Before designing banner keep these points in mind.') }}
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>{{ translate('Photos & Links') }}</label>
						<div class="home-slider-target">
							<input type="hidden" name="types[]" value="home_slider_images_ar">
							<input type="hidden" name="types[]" value="home_slider_links_ar">
							@if (get_setting('home_slider_images_ar') != null)
								@foreach (json_decode(get_setting('home_slider_images_ar'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
													<input type="hidden" name="types[]" value="home_slider_images_ar">
					                                <input type="hidden" name="home_slider_images_ar[]" class="selected-files" value="{{ json_decode(get_setting('home_slider_images_ar'), true)[$key] }}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_slider_links_ar">
												<input type="text" class="form-control" placeholder="http://" name="home_slider_links_ar[]" value="{{ json_decode(get_setting('home_slider_links_ar'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-auto">
											<div class="form-group">
						...
						<button
							...
							<div class="row gutters-5">
								<div class="col-md-5">
									<div class="form-group">
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											...
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[]" value="home_slider_images_ar">
											<input type="hidden" name="home_slider_images_ar[]" class="selected-files">
										</div>
										<div class="file-preview box sm">
										</div>
									</div>
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_slider_links_ar">
										<input type="text" class="form-control" placeholder="http://" name="home_slider_links_ar[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Mobile App Slider') }}</h6>
			</div>
			<div class="card-body">
				<div class="alert alert-info">
					{{ translate('We have limited banner height to maintain UI. We had to crop from both left & right side in view for different devices to make it responsive. Before designing banner keep these points in mind.') }}
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>{{ translate('Photos & Links') }}</label>
						<div class="home-slider-target">
							<input type="hidden" name="types[]" value="mobile_app_slider_images">
							<input type="hidden" name="types[]" value="mobile_app_slider_links">
							@if (get_setting('mobile_app_slider_images') != null)
								@foreach (json_decode(get_setting('mobile_app_slider_images'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
													<input type="hidden" name="types[]" value="mobile_app_slider_images">
					                                <input type="hidden" name="mobile_app_slider_images[]" class="selected-files" value="{{ json_decode(get_setting('mobile_app_slider_images'), true)[$key] }}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="mobile_app_slider_links">
												<input type="text" class="form-control" placeholder="http://" name="mobile_app_slider_links[]" value="{{ json_decode(get_setting('mobile_app_slider_links'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-auto">
											<div class="form-group">
						...
						<button
							...
							<div class="row gutters-5">
								<div class="col-md-5">
									<div class="form-group">
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											...
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[]" value="mobile_app_slider_images">
											<input type="hidden" name="mobile_app_slider_images[]" class="selected-files">
										</div>
										<div class="file-preview box sm">
										</div>
									</div>
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="mobile_app_slider_links">
										<input type="text" class="form-control" placeholder="http://" name="mobile_app_slider_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
        ...
        {{-- Mobile App Slider Arabic--}}
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Mobile App Slider Arabic') }}</h6>
			</div>
			<div class="card-body">
				<div class="alert alert-info">
					{{ translate('We have limited banner height to maintain UI. We had to crop from both left & right side in view for different devices to make it responsive. Before designing banner keep these points in mind.') }}
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>{{ translate('Photos & Links') }}</label>
						<div class="home-slider-target">
							<input type="hidden" name="types[]" value="mobile_app_slider_images_ar">
							<input type="hidden" name="types[]" value="mobile_app_slider_links_ar">
							@if (get_setting('mobile_app_slider_images_ar') != null)
								@foreach (json_decode(get_setting('mobile_app_slider_images_ar'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
													<input type="hidden" name="types[]" value="mobile_app_slider_images_ar">
					                                <input type="hidden" name="mobile_app_slider_images_ar[]" class="selected-files" value="{{ json_decode(get_setting('mobile_app_slider_images_ar'), true)[$key] }}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="mobile_app_slider_links_ar">
												<input type="text" class="form-control" placeholder="http://" name="mobile_app_slider_links_ar[]" value="{{ json_decode(get_setting('mobile_app_slider_links_ar'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-auto">
											<div class="form-group">
						...
						<button
							...
							<div class="row gutters-5">
								<div class="col-md-5">
									<div class="form-group">
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											...
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[]" value="mobile_app_slider_images_ar">
											<input type="hidden" name="mobile_app_slider_images_ar[]" class="selected-files">
										</div>
										<div class="file-preview box sm">
										</div>
									</div>
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="mobile_app_slider_links_ar">
										<input type="text" class="form-control" placeholder="http://" name="mobile_app_slider_links_ar[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Recommended Sellers') }}</h6>
			</div>
			<div class="card-body">
				<div class="alert alert-info">
					{{ translate('We have limited banner height to maintain UI. We had to crop from both left & right side in view for different devices to make it responsive. Before designing banner keep these points in mind.') }}
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>{{ translate('Photos & Links') }}</label>
						<div class="home-slider-target">
							<input type="hidden" name="types[]" value="recommended_sellers_images">
							<input type="hidden" name="types[]" value="recommended_sellers_links">
							@if (get_setting('recommended_sellers_images') != null)
								@foreach (json_decode(get_setting('recommended_sellers_images'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
													<input type="hidden" name="types[]" value="recommended_sellers_images">
					                                <input type="hidden" name="recommended_sellers_images[]" class="selected-files" value="{{ json_decode(get_setting('recommended_sellers_images'), true)[$key] }}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="recommended_sellers_links">
												<input type="text" class="form-control" placeholder="http://" name="recommended_sellers_links[]" value="{{ json_decode(get_setting('recommended_sellers_links'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-auto">
											<div class="form-group">
						...
						<button
							...
							<div class="row gutters-5">
								<div class="col-md-5">
									<div class="form-group">
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											...
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[]" value="recommended_sellers_images">
											<input type="hidden" name="recommended_sellers_images[]" class="selected-files">
										</div>
										<div class="file-preview box sm">
										</div>
									</div>
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="recommended_sellers_links">
										<input type="text" class="form-control" placeholder="http://" name="recommended_sellers_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
        ...
        {{-- Recommended Sellers arabic --}}
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Recommended Sellers Arabic') }}</h6>
			</div>
			<div class="card-body">
				<div class="alert alert-info">
					{{ translate('We have limited banner height to maintain UI. We had to crop from both left & right side in view for different devices to make it responsive. Before designing banner keep these points in mind.') }}
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>{{ translate('Photos & Links') }}</label>
						<div class="home-slider-target">
							<input type="hidden" name="types[]" value="recommended_sellers_images_ar">
							<input type="hidden" name="types[]" value="recommended_sellers_links_ar">
							@if (get_setting('recommended_sellers_images_ar') != null)
								@foreach (json_decode(get_setting('recommended_sellers_images_ar'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
													<input type="hidden" name="types[]" value="recommended_sellers_images_ar">
					                                <input type="hidden" name="recommended_sellers_images_ar[]" class="selected-files" value="{{ json_decode(get_setting('recommended_sellers_images_ar'), true)[$key] }}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="recommended_sellers_links_ar">
												<input type="text" class="form-control" placeholder="http://" name="recommended_sellers_links_ar[]" value="{{ json_decode(get_setting('recommended_sellers_links_ar'), true)[$key] }}">
											</div>
										</div>
										<div class="col-md-auto">
											<div class="form-group">
						...
						<button
							...
							<div class="row gutters-5">
								<div class="col-md-5">
									<div class="form-group">
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											...
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[]" value="recommended_sellers_images_ar">
											<input type="hidden" name="recommended_sellers_images_ar[]" class="selected-files">
										</div>
										<div class="file-preview box sm">
										</div>
									</div>
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="recommended_sellers_links_ar">
										<input type="text" class="form-control" placeholder="http://" name="recommended_sellers_links_ar[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">

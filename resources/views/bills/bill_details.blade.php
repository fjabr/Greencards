	...
	<body dir="auto">
		...
		<div class="invoice-box">
			<table>
					...
					<td colspan="2">
						<table>
							<tr>
								...
								<td class="title">
									<img src="{{ uploaded_asset(get_setting('system_logo_white')) }}" alt="Green Card SA" style="width: 120px; max-width: 200px" />
								</td>
                ...
                <tr class="heading">
					<td>Customer Email / Mobile</td>
                    <td style="text-align: right;">البريد الإلكتروني او هاتف للعميل</td>
				</tr>

                <tr class="details">
                    <td colspan="2">{{$email ?? $mobile}}</td>
                </tr>
                ...
                <tr class="details">
                    <td colspan="2">
                        <img src="https://qrcode.tec-it.com/API/QRCode?data={{$qr_code}}" width="200px" height="200px" />
                    </td>
                </tr>
        ...
        <div style="margin-top: 15px;">
            <a href="{{route('bills.download_bill', encrypt($payment_id))}}" >
                downlaod my bill
            </a>
            |
            <a href="{{route('bills.send_bill_via_email', encrypt($payment_id))}}" >
                Send my bill via Email
            </a>
    </div>
	</body>
</html>

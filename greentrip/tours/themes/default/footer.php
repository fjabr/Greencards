...
<footer id="footer" class="footer-wrapper scrollspy-stopper <?php echo @$hidden; ?>">
  <div class="container">
    ...
    <div class="container">
   <!--  <div class="text-center"><a href="/" target="_blank"> <img src="<?php echo base_url(); ?>uploads/global/phptravels.png" style="height:22px;display: inline-block; -webkit-transform: translateY(6px);transform: translateY(6px);" height="22" alt="" /> <strong></strong></a></div>
   --></div> 
    </div>
    <!-- ********************   Removing powered by linkback will result to cancellation of your support service.    ********************  -->
    </div>
